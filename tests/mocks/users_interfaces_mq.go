...
func (m *MockUserBuxClient) SendToRecipents(recipients []*transports.Recipients, senderPaymail string) (users.Transaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendToRecipents", recipients, senderPaymail)
	ret0, _ := ret[0].(users.Transaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserBuxClientMockRecorder) SendToRecipents(recipients, senderPaymail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendToRecipents", reflect.TypeOf((*MockUserBuxClient)(nil).SendToRecipents), recipients, senderPaymail)
}
